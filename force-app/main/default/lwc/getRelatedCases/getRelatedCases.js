...
import getRelatedCases from '@salesforce/apex/AccountCasesController.getRelatedCases';
import { getObjectInfo, getPicklistValues} from 'lightning/uiObjectInfoApi';
import STATUS_FIELD from '@salesforce/schema/Case.Status';
import CASE_OBJECT from '@salesforce/schema/Case';
import { NavigationMixin } from 'lightning/navigation'
export default class GetRelatedCases extends NavigationMixin(LightningElement) {
    ...
    loadRelatedCases() {
        getRelatedCases({ accountId: this.recordId })
            .then(result => {
    ...
    filterCases() {
        ...
        else this.filteredCases = this.allCases.filter(item => item.Status === this.selectedStatus);
    }
